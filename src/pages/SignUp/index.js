                ...
                return(
                    ...
                    <div className='row'>
                        <div className='col-md-8 d-flex align-items-center flex-column part1 justify-content-center'>   
                         <h1>BEST UX/UI FASHION <span> ECOMMERCE DASHBOARD</span> & ADMIN PANEL</h1>
                        ...
                        <div className='col-md-4 pr-0'>
                            ...
                            <div className='wrapper mt-3 card border p-4'>
                                ...
                                <spa className='text-center d-block mt-3'>
                                Don't have an account?
                                <Link to={'/signUp'} className='link color ml-2'>Sign In</Link>
                               </spa>
